...
/**
 *
 * @description Преветсятвенная страница для продавца
 *
 * @returns {JSX.Element}
 * @constructor
 */
				...
				<div className={classes.container}>
					<section className={classes.welcome}>
						<div className={classes.welcome__title}>
							<h1>
								<span className={classes.subtitle}>Объединяем бизнес и покупателя</span>
								<p className={classes.title}>
									Разместите ваши товары на Feed Market уже сегодня
								</p>
							</h1>
							<div className={classes.btn__center}>
								<Link href={'/auth'}>
									<a>
										<Button size={'l'} factor={'green'}>
											Стать продавцом
										</Button>
									</a>
								</Link>
							...
							<Grid container>
								<Grid item xs={3}>
									<div className={classes.stepsBody__step}>
										...
										<p>
											<span>Зарегистрируйтесь</span>в личном кабинете
										</p>
									</div>
								</Grid>
								<Grid item xs={3}>
									<div className={classes.stepsBody__step}>
										...
										<p>
											<span>Выберите товары</span>и загрузите их в систему
										</p>
									</div>
								</Grid>
								<Grid item xs={3}>
					...
					<section className={classes.schemesOfWork}>
						<h2
							className={classNames(classes.sectionTitle, classes.schemesOfWork__title)}>
							Схемы работы на ваш выбор
						</h2>
						<p className={classes.schemesOfWork__subTitle}>
							Предлагаем разные варианты логистики, чтобы вы могли быстро подстроить
							работу с маркетплейсом под особенности своего бизнеса и ассортиментa
						</p>
						...
						<Grid container spacing={2}>
							<Grid item xs={3}>
								<div className={classes.schemesOfWork__scheme}>
									...
									<p className={classes.item1}>
										Собираете заказы не дольше часа, передаёте курьеру для быстрой
										доставки в пределах города.
									</p>
							...
							<Grid item xs={3}>
								<div className={classes.schemesOfWork__scheme}>
									...
									<h3>Склад и доставка – ваши</h3>
									<p>
										<span>Мы выступаем торговой площадкой,</span>
										<span>а размещение на складе, сборка</span>
										<span>и доставка заказов — на вашей</span> стороне.
									</p>
									<h3 className={classes.list}>Как отгружать товар</h3>
									<ul>
										<li>На условиях вашего перевозчика</li>
							...
							<Grid item xs={3}>
								<div className={classes.schemesOfWork__scheme}>
									...
									<h3>Склад и доставка – ваши</h3>
									<p>
										Размещаете товары на своём складе, собираете заказы и передаёте
										готовые упаковки в Feed Market для доставки покупателям.
									</p>
									<h3 className={classes.list}>Как отгружать товар</h3>
									<ul>
							...
							<Grid item xs={3}>
								<div className={classes.schemesOfWork__scheme}>
									...
									<h3>Склад и доставка – ваши</h3>
									<p>
										Размещение на складе, сборка и доставка товаров — на нашей стороне.
										Вам остаётся лишь передать нам товары.
									</p>
									<h3 className={classes.list}>Как отгружать товар</h3>
									<ul className={classes.item2}>
										<li>Hа ближайший склад Feed Market</li>
										<li>Hа любой склад Feed Market в России через кросс-док</li>
									</ul>
									<h3>Кто упаковывает заказ</h3>
									<p>Продавец</p>
									<h3 className={classes.list}>Кто доставляет</h3>
							...
							<Grid container spacing={3}>
								<Grid item xs={4}>
									<div className={classes.stepsBody__step}>
										<div className={classes.stepsBody__imgWrapper}>
											<Image alt="image" src={checkboxImg} />
										</div>
										<p>
											Помощь с подключением к площадке —{' '}
											<span className={classes.color}>сертифицированные партнёры</span>{' '}
											помогут с выходом на маркетплейс
										</p>
									</div>
								</Grid>
								<Grid item xs={4}>
									<div className={classes.stepsBody__step}>
										...
										<p>
											Бесплатное размещение на складе Feed Market в первый месяц — для
											любых товаров
										</p>
									</div>
								</Grid>
								<Grid item xs={4}>
									<div className={classes.stepsBody__step}>
										...
										<p>
											Возможность получить финансирование — выгодные условия кредитования
											на платформе Feed Market
										</p>
									</div>
								</Grid>
							</Grid>
						...
						<CardCarousel
							...
							<div className={classes.comments__wrapper}>
								...
								<div className={classes.chevrons}>
									<button className={classNames(classes.chevron)} ref={lb}>
										<Image alt="image" src={chevronLeft} />
									</button>
									<button className={classNames(classes.chevron)} ref={rb}>
										<Image alt="image" src={chevronRight} />
									</button>
								</div>
							</div>
					...
					<section className={classes.steps}>
						...
						<div className={classes.steps__body}>
							...
							<p className={classes.footer__text}>
								Напишите нашему чат-боту, он всё знает. А если нужно больше деталей, ищите
								ответы в <span>базе знаний</span>.
							</p>
						</div>

						<div
							className={classNames(
								classes.steps__buttonWrapper,
